...
public class ObjectStoreFileSystemTest extends COSBaseTest {

  private ObjectStoreFileSystem mMockObjectStoreFileSystem;
  private StocatorPath mMockStocatorPath;
  private String hostName = "cos://out1003.lvm";
  ...
  public void getObjectNameTest() throws Exception {
    Path input = new Path("cos://out1003.lvm/a/b/c/m.data/_temporary/"
    ...
    input = new Path("cos://out1003.lvm/a/b/m.data/_temporary/"
            + "0/_temporary/attempt_201603141928_0000_m_000099_102/part-00099");
    ...
    input = new Path("cos://out1003.lvm/m.data/_temporary/"
            + "0/_temporary/attempt_201603141928_0000_m_000099_102/part-00099");
    result = Whitebox.invokeMethod(mMockStocatorPath, "parseHadoopFOutputCommitterV1", input,
        true, hostName);
  ...
  public void getObjectWrongNameTest() throws Exception {
    Path input = new Path("cos://out1003.lvm_temporary/"
            + "0/_temporary/attempt_201603141928_0000_m_000099_102/part-00099");
    Whitebox.invokeMethod(mMockStocatorPath, "parseHadoopFOutputCommitterV1", input,
        true, hostName);

    input = new Path("cos://out1003.lvm/temporary/"
            + "0/_temporary/attempt_201603141928_0000_m_000099_102/part-00099");
    Whitebox.invokeMethod(mMockStocatorPath, "parseHadoopFOutputCommitterV1", input,
        true, hostName);
  }
  ...
  public void getSchemeTest() throws Exception {
    ...
    Assert.assertEquals(COSConstants.COS, getFs().getScheme());
  }
  ...
  public void openCreateTest() throws Exception {
    ...
    System.out.println(testFile.getName().toString());
