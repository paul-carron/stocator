...
public class StreamingCOSTest {
  ...
  // @Test
  public void accessPublicCOSContainerWithSpaceTest() throws Exception {
    FileSystem fs = new ObjectStoreFileSystem();
    Configuration conf = new Configuration();
    String uriString = conf.get("fs.cos.test.uri");
  ...
  public void accessObjectWithSpaceTest() throws Exception {
    ...
    try {
      ...
      for (int i = 0; i < 5; i++) {
        ...
        // create timer
        createObjectTimer(59000.0, currObjName);
